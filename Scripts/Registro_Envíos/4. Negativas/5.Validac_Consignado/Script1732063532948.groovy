...
WebUI.click(findTestObject('Registro de envíos/valorados/Page_Olva Courier  Datos Personales/a_LIMA'))
...
WebUI.verifyElementNotClickable(findTestObject('Object Repository/Difuminado/input_OLVA_txt_consignado_ape_mat'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementNotClickable(findTestObject('Object Repository/Difuminado/input_CARN EXT_txt_consignado_nom_completo'), 
...
WebUI.click(findTestObject('Object Repository/Difuminado/button_Editar'))

WebUI.delay(3)

WebUI.verifyElementNotChecked(findTestObject('Object Repository/Difuminado/span_QAQA'), 0)

WebUI.verifyElementClickable(findTestObject('Object Repository/Difuminado/input_OLVA_txt_consignado_ape_mat'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementClickable(findTestObject('Object Repository/Difuminado/input_CARN EXT_txt_consignado_nom_completo'), 
    FailureHandling.STOP_ON_FAILURE)
