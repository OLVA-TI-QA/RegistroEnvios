...
WebUI.scrollToElement(findTestObject('Registro de envíos/Test cases/b_PagoEfectivo'), 0, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Registro de envíos/Test cases/b_PagoEfectivo'), FailureHandling.STOP_ON_FAILURE)
