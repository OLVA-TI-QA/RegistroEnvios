...
WebUI.setText(findTestObject('Registro de envíos/valorados/Page_Olva Courier  Datos Personales/input_Qu Envas_input_descripcion'), 
    'GHJK')

WebUI.setText(findTestObject('Registro de envíos/valorados/Page_Olva Courier  Datos Personales/input_Qu Envas_input_valor'), 
    '12')
...
WebUI.setText(findTestObject('Object Repository/Registro de envíos/Test cases/input_dir_entreg'), 'COMANDANTE ESPINAR 659, MIRAFLORES, LIMA, LIMA, PERU', 
