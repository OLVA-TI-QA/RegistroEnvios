...
WebUI.scrollToElement(findTestObject('Object Repository/Registro de envíos/valorados/Page_Olva Courier  Datos Personales/button_CONTINUAR'), 
    0)
...
WebUI.scrollToElement(findTestObject('Object Repository/th_S 10.00'), 0)
