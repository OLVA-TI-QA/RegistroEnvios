...
WebUI.click(findTestObject('Object Repository/Difuminado/span_Seleccionar artculo'))

WebUI.click(findTestObject('Object Repository/Difuminado/span_ACCESORIOS Y EQUIPOS ELECTRONICOS'))

WebUI.setText(findTestObject('Object Repository/Difuminado/input_UTILES DE OFICINA_txt_paquete_articulo'), 'GHJk')

WebUI.setText(findTestObject('Object Repository/Difuminado/input_UTILES DE OFICINA_txt_paquete_valor'), '12')

WebUI.setText(findTestObject('Object Repository/Difuminado/input_UTILES DE OFICINA_txt_paquete_largo'), '12')

WebUI.setText(findTestObject('Object Repository/Difuminado/input_cm_txt_paquete_ancho'), '13')

WebUI.setText(findTestObject('Object Repository/Difuminado/input_cm_txt_paquete_altura'), '14')

WebUI.setText(findTestObject('Object Repository/Difuminado/input_cm_txt_paquete_peso'), '1')

WebUI.click(findTestObject('Object Repository/Difuminado/button_Ingrese el punto de partida'))

WebUI.click(findTestObject('Object Repository/Difuminado/a_LIMA'))
...
WebUI.click(findTestObject('Object Repository/Difuminado/span_OLVA LINCE - AV. ARENALES 1775 - LINCE_e0577d'))
