...
WebUI.setText(findTestObject('Object Repository/Registro de envíos/Test cases/input_pqte_val'), '1001', FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementText(findTestObject('Object Repository/Registro de envíos/valorados/Page_Olva Courier  Datos Personales/p_El artculo que supera los 1000 soles no p_4059db'), 
    'El artículo que supera los 1000 soles no pueden ser entregados en tienda')

WebUI.click(findTestObject('Object Repository/Registro de envíos/valorados/Page_Olva Courier  Datos Personales/button_Aceptar'))
